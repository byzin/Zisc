...
/*!
  ...
  */
short Algorithm::clzMsvcImpl(const short x) noexcept
{
...
/*!
  ...
  \return No description
  */
unsigned short Algorithm::clzMsvcImpl(const unsigned short x) noexcept
{
...
/*!
  ...
  \return No description
  */
int Algorithm::clzMsvcImpl(const int x) noexcept
{
...
/*!
  ...
  \return No description
  */
unsigned int Algorithm::clzMsvcImpl(const unsigned int x) noexcept
{
...
/*!
  ...
  \return No description
  */
long long Algorithm::clzMsvcImpl(const long long x) noexcept
{
...
/*!
  ...
  \return No description
  */
unsigned long long Algorithm::clzMsvcImpl(const unsigned long long x) noexcept
{
