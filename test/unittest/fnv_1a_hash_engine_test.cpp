...
TEST(Fnv1aHashEngineTest, 32BitHashTest)
{
  ...
  {
    constexpr char seed[] = "";
    constexpr zisc::uint32 result = Fnv1aHash::hash(seed);
  ...
  }
  {
    ...
    const zisc::uint32 result = Fnv1aHash::hash(seed);
...
TEST(Fnv1aHashEngineTest, 64BitHashTest)
{
  ...
  {
    constexpr char seed[] = "";
    constexpr zisc::uint64 result = Fnv1aHash::hash(seed);
  ...
  {
    const char seed[] = "foobar";
    const zisc::uint64 result = Fnv1aHash::hash(seed);
